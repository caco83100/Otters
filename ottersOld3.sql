...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 03 déc. 2024 à 08:59
...
(1, 'Le Belvédère', '#D7CEC1'),
(2, 'Le Plateau', '#E5CCC0'),
(3, 'Les Clairières', '#EDDDAC'),
(4, 'Le Bois des Pins', '#DADEBE'),
(5, 'Le Vallon des Cascades', '#C8D1D6'),
(6, 'La Bergerie des Reptiles', '#B9D3CA');
...
INSERT INTO `enclosure` (`id_enclosure`, `id_biome`, `meal`) VALUES
(1, 5, 0),
(2, 5, 0),
(3, 5, 0),
(4, 1, 0),
